...
def main(config_file_path):
    ...
    camera = build_camera(picam = autolander_config.camera_config.use_picamera,
    ...
    # streaming
    streamer_config = WebRTCConfig(host="0.0.0.0", port=autolander_config.streaming_config.port, stream_fps= autolander_config.streaming_config.video.fps)
